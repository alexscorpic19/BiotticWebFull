  ...
  const team = [
    {
      ...
      image: `${BASE_URL.replace('/api', '')}/uploads/corzo.png`
    },
    {
    ...
    },
    {
      ...
      image: `${BASE_URL.replace('/api', '')}/uploads/CarlosM.png`
    }
  ];
